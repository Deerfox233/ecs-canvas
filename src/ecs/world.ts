...
export class World {
     ...
     */
    public findEntitiesWithComponents(componentTypes: Set<ComponentType>): Set<Entity> {
    ...
    public addSystem(system: System): void {
        if (system.depComponents.size === 0) {
            console.warn('this system has no dependencies, it will run on all entities in the world');
        }
